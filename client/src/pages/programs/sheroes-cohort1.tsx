  ...
  return (
    <>
      ...
      {program && (
        <ProgramImpactBanner
          stats={[
            { label: "Applicants", value: cohort.applied.toString() },
            { label: "Scholars", value: cohort.selected.toString() },
            { label: "Schools", value: cohort.schools.toString() },
            { label: "Month", value: cohort.duration },
          ]}
          cta={{
            label: "Support SHEROES",
            href: "/donate",
          }}
        />
      )}
